...
-- 	and Description_EntryPoint like "%Bar%" -- it has to be changed
...
-- 				
-- 
-- SELECT @mycorridor, @e_mycorridor, @myelevator, 
-- 		@e_myelevator, @groundcorridor, @e_groundcorridor,
--         @servregion, @e_servregion, @room,
--         @arrival, @leaving;
-- 
...
--     into @e_room_2;
-- 
-- select @ground_corridor_2, @e_ground_corridor_2, 
-- 		@myelevator_2, @e_myelevator_2, 
-- 		@mycorridor_2, @e_mycorridor_2, 
--         @e_room_2;
--         
-- 
...
-- 
-- If the ground Corridor isn't connected with any accessible region, i have to move to other corridor
